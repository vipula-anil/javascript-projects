...
/*- one for the starting fuel level, another for the number of astronauts aboard, and the third for the altitude the shuttle reaches.*/
...
while (fuelLevel <=5000 || fuelLevel > 30000 || isNaN(fuelLevel)){
  ...
  fuelLevel = input.question("Please enter starting fuel level 5000 - 30000: ");
  }

//b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.
  
  while (astronautNum < 1 || astronautNum > 7) {
    astronautNum = input.question("Please enter the astronaut count from 1-7 :");
  }
...
while (fuelLevel-100*astronautNum >=0) {
  altitude += 50;
